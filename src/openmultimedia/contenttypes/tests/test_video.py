...
class ContentTypeTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.folder.invokeFactory('openmultimedia.contenttypes.video', 'v1')
        self.v1 = self.folder['v1']

    def test_adding(self):
        self.assertTrue(IVideo.providedBy(self.v1))

    def test_fti(self):
        fti = queryUtility(IDexterityFTI, name='openmultimedia.contenttypes.video')
